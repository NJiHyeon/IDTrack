...
"""
Add default config for IDTrack
"""
cfg = edict()
...
cfg.MODEL.WAY = 'ind' #[ind, seq, base]
...
# DATA
cfg.DATA = edict()
cfg.DATA.SAMPLER_MODE = "causal"  # sampling methods(order)
cfg.DATA.MEAN = [0.485, 0.456, 0.406]
cfg.DATA.STD = [0.229, 0.224, 0.225]
cfg.DATA.MAX_SAMPLE_INTERVAL = 200
cfg.DATA.SEQ_FORMAT = "xyxy" #xyxy, whxy
# DATA.TRAIN
...
cfg.DATA.SEARCH.FACTOR = 5.0 #4.0
cfg.DATA.SEARCH.CENTER_JITTER = 4.5 #3.5
cfg.DATA.SEARCH.SCALE_JITTER = 0.5
cfg.DATA.SEARCH.NUMBER = 1 #1
# DATA.TEMPLATE
cfg.DATA.TEMPLATE = edict()
cfg.DATA.TEMPLATE.NUMBER = 1
cfg.DATA.TEMPLATE.SIZE = 128
cfg.DATA.TEMPLATE.FACTOR = 2.0 #4.0
cfg.DATA.TEMPLATE.CENTER_JITTER = 0
cfg.DATA.TEMPLATE.SCALE_JITTER = 0

# TEST
cfg.TEST = edict()
cfg.TEST.TEMPLATE_FACTOR = 2.0 #4.0
cfg.TEST.TEMPLATE_SIZE = 128 #256
cfg.TEST.SEARCH_FACTOR = 5.0 #4.0
