...
def transform_got10k(tracker_name, cfg_name):
    ...
    # src_dir = "/mnt/ssd/nozzi/VOT/IDTrack_xyxy_artrack/output/test/tracking_results/idtrack/idtrack_aug_pre1_drop50/%s/got10k/" % (cfg_name)
    # dest_dir = "/mnt/ssd/nozzi/VOT/IDTrack_xyxy_artrack/output/test/tracking_results/idtrack/idtrack_aug_pre1_drop50/%s/got10k_submit/" % (cfg_name)
