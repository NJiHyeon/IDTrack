...
class IDTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        ...
        self.save_all = self.cfg.MODEL.PRENUM
        self.z_dict1 = {}
    ...
    def track(self, image, info: dict = None):
        ...
        pred_boxes = (pred_new * self.params.search_size / resize_factor).tolist() #[cx,cy,w,h]


        # get the final box result
            # map_box_back : cxcywh -> x1y1wh
            # clip_box : x1y1wh -> x1y1wh
