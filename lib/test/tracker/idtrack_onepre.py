...
class IDTrack(BaseTracker):
    ...
    def track(self, image, info: dict = None):
        ...
        with torch.no_grad():
            ...
            # run the transformer
            out_dict = self.network.forward(template=self.z_dict1.tensors, search=x_dict.tensors, seq_input=???)
        # add hann windows
        ...
        pred_new[0] = pred_boxes[0] + pred_boxes[2]/2 #xmin->centerx
        pred_new[1] = pred_boxes[1] + pred_boxes[3]/2 #ymin->centery
