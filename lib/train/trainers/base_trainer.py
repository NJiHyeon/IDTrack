...
class BaseTrainer:
    """ 
    Base trainer class.
    Contains functions for training and saving/loading checkpoints.
    ...
    def update_settings(self, settings=None) :
        """ 
        Updates the trainer settings. Must be called to update interal settings.
        """
        ...
        for i in range(num_tries):
            try :
                ...
                for epoch in range(self.epoch+1, max_epochs+1) :
                    ...
                    if epoch>=20 or save_every_epoch or epoch%5==0 :
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        if checkpoint is None:
            ...
            if checkpoint_list:
                ...
                print('No matching checkpoint file found.(저장된 체크포인트 없음)')
                return
