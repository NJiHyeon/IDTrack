...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None, use_lmdb=False,
                 script_name_prv=None, config_name_prv=None, use_wandb=False, 
                 distill=None, script_teacher=None, config_teacher=None):
    """Run the train script.
    args:
        sciprt_name: Name of experiments in the "experiments/" folder.
        config_name: Name of yaml file in the "experiments/<script_name>".
        cudnn_benchmark: Use cudnn benchmark or not (default is Ture).
    """
    if save_dir is None:
