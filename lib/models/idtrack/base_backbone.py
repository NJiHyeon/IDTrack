...
from lib.models.idtrack.utils import combine_tokens, recover_tokens
...
class BaseBackbone(nn.Module):
    ...
    def forward(self, z, x, identity, **kwargs) :
        ...
        Args :
            z (torch.Tensor) : tempalte feature, [B, C, H_z, W_z]
            x (torch.Tensor) : search features, [B, C, H_x, W_x]
            
        Returns :
            x (torch.Tensor) : merged template and search region feautre, [B, L_z+L_x, C]
            attn : None
        """
